...
<div class="container focus">
	...
	<div class="row">
		<div class="col-md-4">
			<div class="img-focus">
				<?= $this->Html->image('features/fork.png') ?>
			</div>
			<h2>
				<?= __("Open Source") ?>
			</h2>
		...
		<div class="col-md-4">
			<div class="img-focus">
				<?= $this->Html->image('features/beaker.png') ?>
			</div>
			<h2>
				<?= __("Experiences") ?>
			</h2>
		...
		<div class="col-md-4">
			<div class="img-focus">
				<?= $this->Html->image('features/interact.png') ?>
			</div>
			<h2>
				<?= __("Interact") ?>
			</h2>
		...
		<div class="articles">
			<div class="carousel">
				...
				<div class="customNavigation">
					<a class="btn btn-default prev"><i class="fa fa-chevron-left"></i></a>
