    ...
    <div class="sidebar-inner">
        <ul class="sidebar-nav nav nav-pills nav-stacked hidden-xs hidden-sm">
                ...
                <div class="sidebar-header">
                    ...
                    <div class="information">
                        <div class="username">
                            ...
                            <?= $this->Html->link('<i class="fa fa-lock"></i>', ['controller' => 'users', 'action' => 'logout', 'prefix' => false], ['data-toggle' => 'tooltip', 'data-placement' => 'right', 'data-container' => 'body', 'title' => __d('admin', 'Logout'), 'escape' => false] ) ?>
                        </div>
                        <div class="progress">
            ...
            <?php if (
                ...
                <?php if ($this->request->params['controller'] == 'Articles'
                        || ($this->request->params['controller'] == 'Categories' && $this->request->params['prefix'] == 'admin')
                ...
                <?php endif;?>
                    ...
                    <ul id="submenu-blog" class="submenu nav collapse">
                        ...
                        <?php if ($this->Acl->check(['controller' => 'categories', 'action' => 'index', 'prefix' => 'admin'])): ?>
                            <?= ($this->request->params['controller'] == 'Categories' && $this->request->params['prefix'] == 'admin') ? '<li class="active">' : '<li>' ?>
            ...
            <?php if ($this->Acl->check(['controller' => 'users', 'action' => 'index', 'prefix' => 'admin'])): ?>
                <?php if ($this->request->params['prefix'] == 'admin' && $this->request->params['controller'] == 'Users'): ?>
                    <li class="active">
                <?php else:?>
                    <li>
                <?php endif;?>
        ...
        <ul class="sidebar-nav nav hidden-md hidden-lg">
            ...
            <?php else:?>
                <li>
            <?php endif;?>
                <?= $this->Html->link('<i class="fa fa-dashboard fa-2x"></i>', ['controller' => 'admin', 'action' => 'home', 'prefix' => 'admin'],
                ['escape' => false]) ?>
            </li>
            ...
            <?php if ($this->Acl->check(['controller' => 'users', 'action' => 'index', 'prefix' => 'admin'])): ?>
                ...
                <?php else:?>
                    <li>
                <?php endif;?>
                    <?= $this->Html->link('<i class="fa fa-user fa-2x"></i>', ['controller' => 'users', 'action' => 'index', 'prefix' => 'admin'],
                        ['escape' => false]
                    ) ?>
                </li>
            <?php endif; ?>
