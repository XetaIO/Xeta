<?= $this->assign('title', __d('admin', 'Add a Poll')) ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12 heading">
            <h1 class="page-header">
                <i class="fa fa-plus"></i> <?= __d('admin', 'Add a Poll') ?>
            </h1>
            <ol class="breadcrumb">
                <li>
        ...
        <div class="col-md-12">
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <?= $this->Form->button(__d('admin', '{0} Create Poll', '<i class="fa fa-plus"></i>'), ['class' => 'col-md-offset-2 btn btn-primary-outline']) ?>
                    <?= $this->Form->end() ?>
                </div>
