<?= $this->assign('title', __("Add an Attachment")); ?>
	...
	<div class="row">
		...
		<div class="col-md-12 heading">
			<h1 class="page-header">
				<i class="fa fa-plus"></i> <?= __("Add an Attachment");?>
			</h1>
			<ol class="breadcrumb">
				<li>
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?= $this->Form->button(__('Create Attachment'), ['class' => 'col-md-offset-2 btn btn-primary']) ?>
					<?= $this->Form->end() ?>
