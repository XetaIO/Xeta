<?= $this->assign('title', __d('admin', 'Add an Offer')) ?>
	...
	<div class="row">
		...
		<div class="col-md-12 heading">
			<h1 class="page-header">
				<i class="fa fa-add"></i> <?= __d('admin', 'Add an Offer') ?>
			</h1>
			<ol class="breadcrumb">
				<li>
				...
				<li class="active">
					<i class="fa fa-plus"></i> <?= __d('admin', 'Add an Offer') ?>
				</li>
			</ol>
		</div>
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?= $this->Form->button(__d('admin', 'Create Offer'), ['class' => 'col-md-offset-2 btn btn-primary']) ?>
					<?= $this->Form->end() ?>
