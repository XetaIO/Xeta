<?= $this->assign('title', __d('admin', 'Add a Discount')) ?>
	...
	<div class="row">
		...
		<div class="col-md-12 heading">
			<h1 class="page-header">
				<i class="fa fa-add"></i> <?= __d('admin', 'Add a Discount') ?>
			</h1>
			<ol class="breadcrumb">
				<li>
				...
				<li>
					<?= $this->Html->link(__d('admin', '{0} Manage Discounts', '<i class="fa fa-gift"></i>'), ['controller' => 'offers',
					'action' => 'index', 'prefix' => 'admin/premium'], ['escape' => false]) ?>
				</li>
				<li class="active">
					<i class="fa fa-plus"></i> <?= __d('admin', 'Add a Discount') ?>
				</li>
			</ol>
		</div>
		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<?= $this->Form->button(__d('admin', 'Create Discount'), ['class' => 'col-md-offset-2 btn btn-primary']) ?>
					<?= $this->Form->end() ?>
